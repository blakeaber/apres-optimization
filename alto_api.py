...
class DynamicVariables(BaseModel):
    demand_forecast: VectorInput
    minimum_shifts: Union[VectorInput, None] = None
    rush_hours: Union[VectorInput, None] = None
    market_hours: Union[VectorInput, None] = None

class OptimizerInput(BaseModel):
    run_id: str = "2878898c-263f-4a32-9c14-ff15b60f91e3"
