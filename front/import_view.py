...
layout = html.Div([
    html.Div([
        html.H4('Hi! Please upload data (in 15 minute increments) to create a schedule 😃'),
...
def parse_contents(contents, filename, date):
    ...
    return html.Div([
        ...
        dash_table.DataTable(df.to_dict('records'), [{'name': i, 'id': i} for i in df.columns], page_size=5),
